...
class SampleForm(forms.Form):
  first_name=forms.CharField( max_length=20, required=True,label="First Name",help_text="Note:Space and special chars are not aallowed")
  last_name=forms.CharField( max_length=20, required=False,label="Last Name")
  email=forms.EmailField(max_length=100, required=True,label="Email")
  phno=forms.IntegerField(max_value=9999999999, min_value=6000000000,required=True,label="Phone No.")
